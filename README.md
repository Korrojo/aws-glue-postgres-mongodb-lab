...
`GLUE-000` — governance and repository skeleton — is **IN PROGRESS**. Operational Docker, AWS, database, Glue, transformation, validation, and destruction components belong to later roadmap tasks and are not implemented. See the [roadmap](docs/project/ROADMAP.md) for task ownership and status.
