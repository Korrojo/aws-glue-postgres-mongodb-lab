...
`GLUE-000` — governance and repository skeleton — is **PR OPEN** in [PR #1](https://github.com/Korrojo/aws-glue-postgres-mongodb-lab/pull/1). Operational Docker, AWS, database, Glue, transformation, validation, and destruction components belong to later roadmap tasks and are not implemented. See the [roadmap](docs/project/ROADMAP.md) for task ownership and status.
